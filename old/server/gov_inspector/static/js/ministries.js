...
$(document).ready(function () {
    ...
    function createDashboard() {
        ...
        // bind the events
        google.visualization.events.addListener(gii.officeTable, 'select', updatePerformanceChart);
        google.visualization.events.addListener(gii.officeTable, 'select', updateIssuesTable);
    }
